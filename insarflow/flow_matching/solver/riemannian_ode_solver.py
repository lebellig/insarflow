...
from insarflow.flow_matching.solver.solver import Solver
from insarflow.flow_matching.utils import ModelWrapper
    ...
    def sample(
        ...
        **model_extras,
        ...
        Args:
            ...
            time_grid (Tensor, optional): Defaults to torch.tensor([0.0,1.0]).
